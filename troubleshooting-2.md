...
fakeStarWars <- tibble(
  name = c("Luke Skywalker", "C-3PO", "R2-D2", "Darth Vader", "Leia Organa", "Owen Lars", "Beru Whitesun Iars", "R5-D4"),
  birth_year = 1998:2005,
  birth_weight = (birth_year - 1995) * 0.45,
  birth_location = c("Liverpool, England", "Liverpool, England", "Seattle, WA", "Liverpool, England", "New York, NY", "Seattle, WA", "Liverpool, England", "New York, NY")
)

fakeStarWarsFormatted <- fakeStarWars %>%
  select(name, birth_weight, birth_year, birth_location)

fakeStarWarsFormatted
```
